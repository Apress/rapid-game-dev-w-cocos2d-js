...
var DampedSpringLayer = BaseSampleLayer.extend({
    ...
    ctor:function () {
      ...
      var dampedSpring = new cp.DampedSpring(bodyA, bodyB, cc.p(50,0), cc.p(25,0), 25, 5, 0.6);
...
var DampedSpringScene = BaseSampleScene.extend({
    runThisSample:function (num) {
        this.addChild(new DampedSpringLayer());
