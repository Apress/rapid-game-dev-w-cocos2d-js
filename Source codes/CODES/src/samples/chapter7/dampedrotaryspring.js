...
var DampedRotarySpringLayer = BaseSampleLayer.extend({
    ...
    ctor:function () {
      ...
      var dampedRotarySpring = new cp.DampedRotarySpring(bodyA, bodyB, 0, 25, 0.6);
...
var DampedRotarySpringScene = BaseSampleScene.extend({
    runThisSample:function (num) {
      this.addChild(new DampedRotarySpringLayer());
